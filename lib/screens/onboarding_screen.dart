...
import 'package:cookipidia/screens/verify_email_page.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget buildPages() {
    return PageView(
      ...
      children: [
        onboardPageView(
          const AssetImage('assets/cookipidia_assets/recommend.png'),
          '''Check out weekly recommended recipes and what your friends are cooking!''',
        ),
        onboardPageView(
          const AssetImage('assets/cookipidia_assets/sheet.png'),
          'Cook with step by step instructions!',
        ),
        onboardPageView(
          const AssetImage('assets/cookipidia_assets/list.png'),
